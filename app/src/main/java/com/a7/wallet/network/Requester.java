...
public class Requester {
    ...
    public static void checkVCode(String tel, int vCode, DataCallBack<BaseResponse> handler) {
    ...
    public  static void login(String user, String password, int gameVersion, DataCallBack<UserInfo> handler) {
        RequestFactory.request(getApi(App.APP_CONTEXT).login(user, password, gameVersion), handler);
    }

    public static void logout(DataCallBack<BaseResponse> handler) {
        RequestFactory.request(getApi(App.APP_CONTEXT).logout(), handler);
    }

    public static void editHeadPic(long userID, String suffix, String picBase64, DataCallBack<BaseResponse> handler) {
    ...
    public static void exchangeDiamondCoin(String userId, String toUserID, double amount, DataCallBack<BaseResponse> handler) {
    ...
    public static  void exchangeDiamondCoinByAddress(String walletAddr, String toWalletAddr, double amount, DataCallBack<BaseResponse> handler) {
    ...
    public static void findPayLogByAddress(String walletAddr, String toWalletAddr, int type, int moneyType, int pageNumber, DataCallBack<PayLogResponse> handler) {
        RequestFactory.request(getApi(App.APP_CONTEXT).findPayLog(walletAddr, toWalletAddr, type, moneyType, pageNumber), handler);
    }
}
